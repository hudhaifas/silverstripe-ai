 ...
 *
 * 3. Provider selection driven by AIChatModel->Provider field (OpenAI / Anthropic).
...
abstract class DataObjectAgent extends Agent {
     ...
     * @param AIChatModel $model The AI model configuration.
     ...
     * @return AIChatModel
     */
    public function getModel(): AIChatModel {
        return $this->model;
    }
    ...
    /**
     * Instantiate the AI provider based on AIChatModel->Provider.
     *
